...
public class CustomItemTouchHelper extends RecyclerView.ItemDecoration
     ...
     */
    com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.Callback mCallback;
     ...
     * {@link com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.Callback#getAbsoluteMovementFlags(RecyclerView, RecyclerView.ViewHolder)} for the current
     * action state.
     */
    int mSelectedFlags;
     ...
     * jumpy UIs.
     */
    List< com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.RecoverAnimation> mRecoverAnimations = new ArrayList<>();
     ...
     */
    private com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.ItemTouchHelperGestureListener mItemTouchHelperGestureListener;
    ...
    private final RecyclerView.OnItemTouchListener mOnItemTouchListener = new RecyclerView.OnItemTouchListener() {
        ...
        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent event) {
            ...
            if (action == MotionEvent.ACTION_DOWN) {
                ...
                if (mSelected == null) {
                    final com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.RecoverAnimation animation = findAnimation(event);
                    if (animation != null) {
        ...
        public void onTouchEvent(RecyclerView recyclerView, MotionEvent event) {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_UP:
                    if( mCallback.isResponseDragStop() ) {
                        mCallback.onDragStop(mRecyclerView, viewHolder);
                    }
                    select(null, ACTION_STATE_IDLE);
                    mActivePointerId = ACTIVE_POINTER_ID_NONE;
                    break;
     ...
     */
    public CustomItemTouchHelper(com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.Callback callback) {
        mCallback = callback;
    }
    ...
    private void destroyCallbacks() {
        ...
        for (int i = recoverAnimSize - 1; i >= 0; i--) {
            final com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.RecoverAnimation recoverAnimation = mRecoverAnimations.get(0);
    ...
    private void startGestureDetection() {
        mItemTouchHelperGestureListener = new com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.ItemTouchHelperGestureListener();
    ...
    void select(RecyclerView.ViewHolder selected, int actionState) {
        ...
        Log.i("CustomItemTouchHelper","select");
        ...
        if (mSelected != null) {
            ...
            if (prevSelected.itemView.getParent() != null) {
                ...
                final com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.RecoverAnimation rv = new com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.RecoverAnimation(prevSelected, animationType,
    ...
    void postDispatchSwipe(final com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.RecoverAnimation anim, final int swipeDir) {
    ...
    int endRecoverAnimation(RecyclerView.ViewHolder viewHolder, boolean override) {
        final int recoverAnimSize = mRecoverAnimations.size();
        for (int i = recoverAnimSize - 1; i >= 0; i--) {
            final com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.RecoverAnimation anim = mRecoverAnimations.get(i);
     ...
     * {@link com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.Callback#isLongPressDragEnabled()}.
     * <p>
     ...
     * ItemTouchHelper
     * is attached.</li>
     * <li>{@link com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.Callback} must have dragging enabled.</li>
     ...
     *                   RecyclerView.
     * @see com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.Callback#isItemViewSwipeEnabled()
     */
     ...
     * behavior
     * by overriding {@link com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.Callback}
     * <p>
     * For this method to work:
     * <ul>
     * <li>The provided ViewHolder must be a child of the RecyclerView to which this
     * ItemTouchHelper is attached.</li>
     * <li>{@link com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.Callback} must have swiping enabled.</li>
     * <li>There must be a previous touch event that was reported to the ItemTouchHelper
     * through RecyclerView's ItemTouchListener mechanism. As long as no other ItemTouchListener
     * grabs previous events, this should work as expected.</li>
     * </ul>
    ...
    com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.RecoverAnimation findAnimation(MotionEvent event) {
        ...
        if (Math.abs(mDx) > Math.abs(mDy)) {
            if ((swipeDir = checkHorizontalSwipe(viewHolder, flags)) > 0) {
                ...
                if ((originalFlags & swipeDir) == 0) {
                    // convert to relative
                    return com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.Callback.convertToRelativeDirection(swipeDir,
                            ViewCompat.getLayoutDirection(mRecyclerView));
                }
                return swipeDir;
            }
     ...
     * {@link com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper}.
     */
    public interface ViewDropHandler {

        /**
         * Called by the {@link com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper} after a View is dropped over another View.
         * <p>
     ...
     * {@link com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.SimpleCallback}.
     * <p>
     * If user drags an item, ItemTouchHelper will call
     * {@link com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.Callback#onMove(RecyclerView, RecyclerView.ViewHolder, RecyclerView.ViewHolder)
    ...
    public abstract static class Callback {
        ...
        /**
         * Returns the {@link ItemTouchUIUtil} that is used by the {@link com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.Callback} class for
         * visual
         ...
         * <p>
         * By default, {@link com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.Callback} applies these changes on
         ...
         * </pre>
         *
         * @return The {@link ItemTouchUIUtil} instance that is used by the {@link com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.Callback}
         */
        ...
        public boolean isResponseDragStop() {
            return true;
        }
        ...
        public abstract void onDragStop(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder);
        /**
         ...
         *                    it is cleared.
         * @param actionState One of {@link com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper#ACTION_STATE_IDLE},
         *                    {@link com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper#ACTION_STATE_SWIPE} or
         *                    {@link com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper#ACTION_STATE_DRAG}.
        ...
        public void onMoved(final RecyclerView recyclerView,
            ...
            if (layoutManager instanceof com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.ViewDropHandler) {
                ((com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.ViewDropHandler) layoutManager).prepareForDrop(viewHolder.itemView,
                        target.itemView, x, y);
                return;
            }
        ...
        void onDraw(Canvas c, RecyclerView parent, RecyclerView.ViewHolder selected,
                    List<com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.RecoverAnimation> recoverAnimationList,
                    int actionState, float dX, float dY) {
            final int recoverAnimSize = recoverAnimationList.size();
            for (int i = 0; i < recoverAnimSize; i++) {
                final com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.RecoverAnimation anim = recoverAnimationList.get(i);
                anim.update();
     ...
     * </pre>
     */
    public abstract static class SimpleCallback extends com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.Callback {
    ...
    private class ItemTouchHelperGestureListener extends GestureDetector.SimpleOnGestureListener {
         ...
         * {@link com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.ItemTouchHelperGestureListener#onLongPress(MotionEvent)}.
         *
         ...
         * {@link com.wecyberstage.wecyberstage.view.helper.CustomItemTouchHelper.ItemTouchHelperGestureListener#onLongPress(MotionEvent)} being called.
         */
